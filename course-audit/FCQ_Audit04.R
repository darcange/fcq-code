...
# L:\mgt\FCQ\R_Code\FCQ_Audit04.R - Vince Darcangelo, 9/19/22
#########################################################################
...
saveWorkbook(audit_all, paste0("L:\\mgt\\FCQ\\CourseAudit\\audit", term_cd, "_", format(appenddt, format = "%m%d%y"), ".xlsx"), overwrite = TRUE)
